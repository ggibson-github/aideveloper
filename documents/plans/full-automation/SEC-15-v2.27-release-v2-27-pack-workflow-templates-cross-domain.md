<!-- Complete pass 1 2026-06-28 SEC-15-v2.27 -->

# SEC-15-v2.27: Release v2.27 pack workflow templates cross-domain

**Parent:** [SEC-15-index](SEC-15-index.md) · **Branch SEC** · **Vision §19** · **Release:** v2.27

## Reader narrative
<!-- prose-source: agent transistor-expansion 2026-06-28 -->

Ships F1.9/F5.4 pack transistors and workflow templates; E7.1/E7.5 template inheritance; C6.4 parallel branches; game studio and data platform reference transistors.
...
SEC-15-v2.27 defines release v2.27 pack workflow templates cross-domain for the agent-driven expert system. Transistor & generator workflow model (§19).
## Scope

- Owns `SEC-15-v2.27` only; siblings under `SEC-15` must not duplicate this spec.
...
1. template-packs/_shared/transistors/ populated.
2. game-asset-pipeline and data-platform packs gain workflows/ trees.
3. list-transistors searches pack overlay.
4. Program parallel lanes run parallel workflow branches.
5. Pack CI transistor validation.
...
{
  "node": "SEC-15-v2.27",
  "description": "release v2.27 pack workflow templates cross-domain",
...
1. Map `SEC-15-v2.27` to release row in [SEC-15-index](SEC-15-index.md) (v2.27).
...
| Check | Command |
|-------|---------|
| Completeness | `python scripts/automation/audit-hierarchy-depth.py --strict --ids SEC-15-v2.27` |
...
- [ ] `python scripts/automation/audit-hierarchy-depth.py --strict --ids SEC-15-v2.27` passes
